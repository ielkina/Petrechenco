...
const personalMovieDB = {
	...
	rememberMyFilms: function () {
		for (let i = 0; i < 2; i++) {
			...
			if (a != null && b != null && a != '' && b != '' && a.length < 50) {
				...
				console.log('error');
				i--; //если условие не выполнилось то i-- вернет на одно действие назад 
			}
		}
	},
	...
	writeYourGenres: function () {
		for (let i = 1; i < 2; i++) {
			//первый вариант выполнения задачи
			...
			//второй вариант выполнения задачи
			...
			if (genres === '' || genres == null) {
				...
				//при методе sort данные сортируются по алфавиту и размеру буквы
				//сначала заглавные потом прописные 
			}
		}
